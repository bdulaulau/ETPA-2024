...
//MonoBehaviour = class de base pour créer des composants custom
{
    ...
    private void Start() //void = pas de résultat à nous donner, Start = comeback de lifecycle, à appeler à un moment clé du cycle de notre jeu début/fin
    {
        ...
        Debug.Log("Attention il se passe des trucs chelou, cours mec tu vas mourir. Je déconne c'est : " + randomNumber); //permet d'afficher dans le debug le nombre 
        messageText.text = "Devine combien de gens sont enterrés dans mon jardin... ?";
    }
